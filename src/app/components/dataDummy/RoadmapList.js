...
export const FRONTEND = [
  ...
  {
    title: "React JS",
    icon: <SiReact size={iconSize} className="text-cyan-600" />,
    linkIndonesia:
...
export const MASTERING_REACT = [
  ...
  {
    title: "React Router",
    icon: <SiReactrouter size={iconSize} className="text-pink-600" />,
    linkIndonesia: "",
    linkEnglish:
  ...
  },
  {
    ...
    icon: <SiStorybook size={iconSize} className="text-pink-600" />,
    linkIndonesia: "",
    linkEnglish:
  ...
  },
  {
    ...
    linkIndonesia: "",
    linkEnglish:
      "https://www.youtube.com/watch?v=YP2f-ErXG_M&list=PLC3y8-rFHvwg7czgqpQIBEAHn8D6l530t",
  },
  {
    title: "React Table",
  ...
  {
    title: "React Query",
    icon: <SiReactquery size={iconSize} className="text-rose-600" />,
    linkIndonesia: "",
    linkEnglish:
  ...
  },
  {
    ...
    icon: <SiReact size={iconSize} className="text-violet-600" />,
    linkIndonesia: "",
    linkEnglish:
  ...
  },
  {
    ...
    icon: <SiReacthookform size={iconSize} className="text-pink-600" />,
    linkIndonesia: "",
    linkEnglish:
